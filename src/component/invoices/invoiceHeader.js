...
const InvoiceHeader = (props) => {
    ...
    const setDocType = (data) => {
        ...
        newHeaderData.invoiceNumber = invoiceNumberBuilder(props.invoiceType, data.value, props.lastInvoice)
    ...
    const setDisableSelectOptions = (option) => {
        if (props.newInvoice)
        ...
        <div className="doc-grid-3-container-auto">
            <div className="margin-all-1">
                ...
                <Select
                    ...
                    isOptionDisabled={(option) => setDisableSelectOptions(option)}
                    onChange={setDocType} />
            </div>
            <div className="margin-all-1">
                <div>numer</div>
